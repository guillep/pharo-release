...
def main() -> int:
    ...
    generator_link = (
        '<a href="https://github.com/guillep/pharo-release">'
        "guillep/pharo-release</a>"
    )
    footer_line = (
        f"Copyright © 2026 Pharo contributors. Generated on "
        f"{html.escape(_human_date(generated_at))} by {generator_link}."
        if generated_at
        else f"Copyright © 2026 Pharo contributors. Generated by "
        f"{generator_link} from release metadata."
    )
